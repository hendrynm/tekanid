        ...
        <div class="row align-items-center">
            ...
            <div class="col-12 col-md-7 col-lg-6 order-md-1" data-aos="fade-up">
                ...
                <div class="text-center text-md-start">
                    ...
                    <a href="#daftarproduk" class="btn btn-primary-soft lift">
                        Lihat Produk
                    </a>
                </div>
            </div>
                ...
                <div class="d-flex text-center justify-content-center">
                    <span class="display-2 mb-0 fw-bolder">
                        <span class="text-primary-desat">
                            Rp<span data-countup='{"startVal":"2500","separator":".","duration":5}' data-to="300" data-aos data-aos-id="countup:in">
                                Rp2.500</span>
                        </span>
                        / jam
                    </span>
...
<section class="pt-8 pt-md-12 pb-10 pb-md-12 pb-lg-13" id="daftarproduk">
    <div class="container">
